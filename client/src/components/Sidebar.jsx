    ...
    <div className="flex justify-between items-center flex-col sticky top-5 h-[93vh]">
      ...
      <div
        className={`flex-1 flex flex-col justify-between items-center ${
          theme === "light" ? "bg-white" : "dark:bg-[#1c1c24]"
        } rounded-[20px] w-[76px] py-4 mt-12`}
      >
        <div className="flex flex-col justify-center items-center gap-3">
          {navlinks.map((link) => {
            const IconComponent =
              theme === "light" ? link.iconLight : link.iconDark;
            return (
              <div
                key={link.name}
                className={`w-[48px] h-[48px] rounded-[10px] ${
                  isActive &&
                  isActive === link.name &&
                  (theme === "light" ? "bg-gray-100" : "dark:bg-[#2c2f32]")
        ...
        <div
          className={`w-[48px] h-[48px] rounded-[10px] ${
            theme === "light" ? "bg-gray-100" : "dark:bg-[#1c1c24]"
