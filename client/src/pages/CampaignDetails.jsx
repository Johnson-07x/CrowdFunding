      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        <div className="flex-1 flex flex-col">
          ...
          >
            <Suspense
              fallback={
                <div className="p-4 text-center">Loading gallery...</div>
              }
            >
          ...
          <div>
            ...
            <div className="mt-[20px] flex flex-row items-center flex-wrap gap-[14px]">
              ...
              <div>
                ...
                <span className="mt-[4px] font-epilogue font-normal text-[12px] text-[#808191] block">
                ...
                <Card>
                  <CardBody>
                    <div className="bg-white px-2 rounded dark:bg-[#1c1c24] text-white ">
                      <Suspense
                        fallback={<div className="p-2">Loading comments…</div>}
                      >
